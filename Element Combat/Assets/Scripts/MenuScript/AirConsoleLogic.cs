...
public class AirConsoleLogic : MonoBehaviour {
    ...
    void Update() {
        ...
        if (currentScene == "TestScene" && pSetup == null) {
            pSetup = GameObject.FindGameObjectWithTag("Manager").GetComponent<GameLogic>();
            players = pSetup.GetComponent<PlayerSetup>().players;
