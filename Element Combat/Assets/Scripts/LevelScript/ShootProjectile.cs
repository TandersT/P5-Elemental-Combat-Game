...
public class ShootProjectile : MonoBehaviour {
    ...
    void rangedAttack(){   
        ...
        if (owner.gameObject.tag == "Player") {
            Temporary_Bullet_Handler.GetComponent<DestroyObject>().element = owner.GetComponent<Player>().element;
            ...
            Temporary_Bullet_Handler.GetComponent<DestroyObject>().element = owner.GetComponent<Minion>().element;
            Rigidbody Temporary_RigidBody;
            Temporary_RigidBody = Temporary_Bullet_Handler.GetComponent<Rigidbody>();
            Temporary_Bullet_Handler.transform.Rotate(Vector3.left * 90);
