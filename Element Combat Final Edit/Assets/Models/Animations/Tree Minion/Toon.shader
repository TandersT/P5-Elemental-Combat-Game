   ...
   SubShader {
      ...
      //   uniform float4 _UnlitColor;
         ...
         float4 frag(vertexOutput input) : COLOR
         {
            ...
            // All vertices are unlit by default. 
            // The unlit colour is 75% of the intensity of the lit colour 
            float3 fragmentColor = _Color.rgb * 0.75; 
 
            // Diffuse illumination lit
            if (attenuation 
      ...
      Pass {      
         ...
         Blend SrcAlpha OneMinusSrcAlpha 
			...
			// THIS PASS IS ONLY USED FOR A SECOND SPECULAR IN THE CASE OF A SECOND LIGHT. WE ONLY USE THIS PASS FOR THE EYES,
			// SINCE THE EYES ARE THE ONLY PART OF THE MODEL WHICH USES TWO SPECULAR HIGHLIGHTS. THE SHADER FOR THE BODY OF THE 
			// MODEL DOESNT USE THIS PASS. THIS IS WHY 'return fragmentColor' IS COMMENTED OUT.
